    ...
    <main className="success-wrap">
      <div className="success-card">
        ...
        <p className="success-subtitle">
          This is not real money or a real purchase. Thanks for subscribing to
          CashPilot. We&apos;ll be in touch within one business day to schedule
          your sensor install and walk you through the dashboard.
        </p>
